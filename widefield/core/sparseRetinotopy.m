...
function [signMap, xMap, yMap] = sparseRetinotopy(U, V, t, stimPositions, stimTimes, mimg, win)
% TODO:
% - revise this according to AP_sparse_noise_retinotopy(Andy) & quickPixelMapRet(Sam)?
% - bootstrapping to obtain VFS (DS/AP)
% - reverse correlation (Sam)
...
%% DS this bit assumes one dot is presented at one time
