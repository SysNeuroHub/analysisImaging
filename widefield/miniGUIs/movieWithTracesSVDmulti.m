...
% movieWithTracesSVDmulti(U, V, t, traces, movieSaveFilePath, frameGenFunc)
% shows multiple movies (V) with an identical U 
% - U is yPix x xPix x nSV
% - V{imovie} is nSV x nTimePoints
...
%             end
    ...
    if ud.currentFrame>size(allData.V{1},2)
        ud.currentFrame=1;
    end
    set(figHandle, 'UserData', ud);
