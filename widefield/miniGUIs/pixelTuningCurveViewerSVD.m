function pixelTuningCurveViewerSVD(U, V, t, eventTimes, eventLabels, calcWin, subtractPre)
% pixelTuningCurveViewerSVD(U, V, t, eventTimes, eventLabels, window)
%
...
if subtractPre %4/6/20
    preIdx = find(winSamps<0);
    avgPeriEventV = avgPeriEventV - mean(avgPeriEventV(:,:,preIdx),3);
end
fprintf(1, 'done.\n');
...
if strcmp(updateType, 'init')
    ...
    hold off;
    colormap(gray);%(colormap_blueblackred);
    caxis(ud.cax);
    axis equal 
    axis off
    colorbar
