...
pixies = [75 191];%[76 78; 56 99; 132 91; 58 119; 89 134; 91 122; 113 107; 94 109; ...
%     91 88; 71 88; 32 91; 58 118; 65 89; 86 91 ];%82 140; 105 145; 73 154; 98 145];
...
%Vs{1}=V;Vs{2}=V;
%movieWithTracesSVDmulti(U,Vs,t,[],[],[]);
%svdViewer(U, Sv, V, 35);
%
%% load mpep data
...
expt = grabStimTimesWF(expt, getAllPhdFlips, [], [], bklightCtrl,1);
    ...
    if ~isempty(pixies)
        for ff = 1:size(pixies,1)
            pixelSingleTrialTracesViewerSVD(U, V, t, mimg, p, expt.stimTimes, stimSequence, ...
                respWin, [pixies(ff,1) pixies(ff,2)], 0, subtractPre);
