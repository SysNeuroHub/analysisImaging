%% when the function is called, pre-calculation
...
%% embed the callback in the figure - the modern way
set(f, 'UserData', ud);
...
%% update brain image and time course and tuning curve
...
%% mouse click ... called within showTC
