...
rawDataDir = 'D:';%'C:\ThorCamData'; 
rootDrive = 'C:\svdinput';

%% load Timeline
load(fullfile(rawDataDir,'dummy_wf\2020-05-12_1\2020-05-12_1_10_dummy_wf_Timeline.mat'));
...
load('purpleOps.mat')
mouseName = 'dummy_wf';
thisDate = '2020-05-12';%[datestr(now,'yyyy-mm-dd')];
thisSeries = 1;
theseFiles = {fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_1.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_2.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_3.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_4.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_5.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_6.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_7.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_8.tif'),...
    fullfile(rawDataDir,'dummy_wf\2020-05-12_1\10_9.tif')};
...
ops.localSavePath = ops.vids(i).fileBase;
