...
try
    ...
    for fileInd = 1:length(theseFiles)
        ...
        if ops.hasBinaryStamp
            ...
            switch ops.rawDataType
                case 'tif' %rewritten for thorcam
                    ...
                    newRecInds = frameIndex + 1; %for thorcams. new file means new experiment
                    ...
                    frameRecIndex(frameIndex+1:frameIndex+nfr) = theseRecIndex(inclFrames); %file number within one experiment?
