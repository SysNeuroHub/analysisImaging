...
rawDataDir = 'D:\ThorCamData'; 
rootDrive = 'C:\svdinput';

%% load Timeline
load(fullfile(rawDataDir,'dummy_wf\2020-05-13_2\2020-05-13_2_2_dummy_wf_Timeline.mat'));
...
load('purpleOps.mat')
mouseName = 'dummy_wf';
thisDate = '2020-05-13';%[datestr(now,'yyyy-mm-dd')];
thisSeries = 2;
theseFiles = {fullfile(rawDataDir,'dummy_wf\2020-05-13_2\2.tif')};
